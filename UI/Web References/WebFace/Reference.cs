...
namespace UI.WebFace {
    ...
    public partial class WSFaces : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetEnableOperationCompleted;
        ...
        /// <remarks/>
        public event GetEnableCompletedEventHandler GetEnableCompleted;
        ...
        /// <remarks/>
        public void AuthenPliceFaceAsync(string IdCard, string RealName, string Phone, string Nation, string Address, byte[] bytes) {
            this.AuthenPliceFaceAsync(IdCard, RealName, Phone, Nation, Address, bytes, null);
        }
        
        /// <remarks/>
        public void AuthenPliceFaceAsync(string IdCard, string RealName, string Phone, string Nation, string Address, byte[] bytes, object userState) {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetEnable", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public int GetEnable(string PMHospName, int EquipmentNumber) {
            object[] results = this.Invoke("GetEnable", new object[] {
                        PMHospName,
                        EquipmentNumber});
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public void GetEnableAsync(string PMHospName, int EquipmentNumber) {
            this.GetEnableAsync(PMHospName, EquipmentNumber, null);
        }
        
        /// <remarks/>
        public void GetEnableAsync(string PMHospName, int EquipmentNumber, object userState) {
            if ((this.GetEnableOperationCompleted == null)) {
                this.GetEnableOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetEnableOperationCompleted);
            }
            this.InvokeAsync("GetEnable", new object[] {
                        PMHospName,
                        EquipmentNumber}, this.GetEnableOperationCompleted, userState);
        }
        
        private void OnGetEnableOperationCompleted(object arg) {
            if ((this.GetEnableCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetEnableCompleted(this, new GetEnableCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void GetEnableCompletedEventHandler(object sender, GetEnableCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetEnableCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetEnableCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
